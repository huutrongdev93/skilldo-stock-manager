<div class="modal fade" id="js_user_debt_debt_modal_payment" tabindex="-1" role="dialog" aria-hidden="true">
    <form class="modal-dialog modal-lg js_user_debt_debt_form_payment" role="document">
        <div class="modal-content">
            ...
            <div class="modal-body">
                <div class="box">
                    <div class="box-header"><span class="js_user_debt_debt_modal_name">Nhà cung cấp</span></div>
                    <div class="box-content">
                        <div class="row">
                            <div class="col-md-6">
                                <div class="row mb-3">
                                    <div class="col-md-6"><b>Nợ hiện tại</b></div>
                                    <div class="col-md-6"><span class="js_user_debt_debt_total"></span></div>
                                </div>
                                <div class="row mb-2">
                                    <div class="col-md-6"><b>Trả cho NCC:</b></div>
                                    <div class="col-md-6">
                                        <input type="text" min="0" name="user_debt_payment" value="0" class="form-control js_input_user_debt_total_payment" />
                                    </div>
                                </div>
                                <div class="row">
                                    <div class="col-md-6"><b>Nợ sau:</b></div>
                                    <div class="col-md-6">
                                        <div class="col-md-6"><span class="js_user_debt_debt_balance"></span></div>
                                    </div>
                                </div>
                            </div>
                ...
                <div class="row mt-4">
                    ...
                    <div class="col-md-7">
                        ...
                        <div class="row mb-2">
                            ...
                            <div class="col-md-5"><span class="js_total_payment_user_debt"></span></div>
                        </div>
                    </div>
                </div>
            </div>
            <div class="modal-footer">
                {!! Admin::button('green', ['text' => 'Tạo phiếu chi', 'icon' => Admin::icon('save'), 'type' => 'button', 'class' => 'js_user_debt_debt_btn_submit']) !!}
...
<script id="user_debt_debt_purchase_order_template" type="text/x-custom-template">
    <tr>
        <td>${code}</td>
        <td>${created}</td>
        <td>${sub_total}</td>
