<div class="dropdown d-inline-block btn-group-sm">
    ...
    <ul class="dropdown-menu">
        ...
        <li>
            <a class="dropdown-item" href="{!! Url::route('admin.stock.purchaseOrders.edit', ['id' => $item->id]).'?type=clone' !!}">
                <i class="fa-duotone fa-solid fa-copy"></i>
                <span>Sao chép</span>
            </a>
        </li>
        <li>
            <a class="dropdown-item js_purchase_order_btn_print" href="#" data-id="{!! $item->id !!}">
