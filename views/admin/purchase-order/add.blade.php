    ...
    <div class="stock-page-form-content">
        <div class="stock-page-header mb-3 gap-4">
            <div class="stock-page-header-title">
                <a href="{!! Url::route('admin.stock.purchaseOrders') !!}" class="fs-4 fw-bold pe-3"><i class="fa-light fa-arrow-left-long"></i></a>
                <span class="fs-3 fw-bold">Nhập Hàng</span>
            </div>
            {!! Plugin::partial(STOCK_NAME, 'admin/search', ['id' => 'purchase_order_new_product_search_item_template']) !!}
