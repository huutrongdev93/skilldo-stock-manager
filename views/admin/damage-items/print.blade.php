<div id="js_damage_items_print_content" class="printBox"></div>
<style>
    .printBox {
...
<script id="damage_items_print_template" type="text/x-custom-template">
    <div class="mb10" style="text-align:center;"><strong class="fs18">PHIẾU XUẤT HỦY HÀNG</strong></div>
...
<script id="damage_items_item_print_template" type="text/x-custom-template">
    <tr>
        <td style="text-align:right;">${stt}</td>
        <td>${product_code}</td>
